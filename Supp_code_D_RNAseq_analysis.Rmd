...
** NOTE: Code chunks 2 and 3 are provided for reference only - all downstream elements for running MOFA are provided in the RData file 
...
load("Supp_code_D_RNAseq_analysis.RData") # modify for local machine directory
```
...
MOFAobject <- selectModel(MOFAlist, plotit = FALSE)   # final MOFAmodel
